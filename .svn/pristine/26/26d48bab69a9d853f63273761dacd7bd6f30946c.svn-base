package br.gov.pi.detran.ouvidoria.modelo.configuracao;
...
public class ErroSistema implements Serializable {
    ...
    @Column(length = 500)
    private String url;
    @Index(name = "idx_errosistema_usuario")
    @ManyToOne
    private Usuario usuario;

    private static final String PACOTE_PADRAO_SISTEMA = "br.gov.pi.detran.ouvidoria";

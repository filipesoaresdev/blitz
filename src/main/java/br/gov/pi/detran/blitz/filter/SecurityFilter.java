package br.gov.pi.detran.blitz.filter;
...
public class SecurityFilter extends AbstractSecurityFilter {
    ...
    public static final String PATTERN = "/admin/view/*";
    private static final Logger logger = Logger.getLogger(SecurityFilter.class.getName());
    private static final String HOME = "/admin/index.jsf";
    private static final String[] IGNORE_URL = {"/admin/view/home.jsf"};

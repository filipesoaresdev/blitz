package br.gov.pi.detran.blitz.bo.email;

import br.gov.pi.detran.blitz.bo.configuracao.ErroSistemaBO;
import br.gov.pi.detran.ouvidoria.modelo.email.Attachment;

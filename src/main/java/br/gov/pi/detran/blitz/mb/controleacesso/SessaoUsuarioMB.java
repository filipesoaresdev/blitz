...
import br.gov.pi.detran.blitz.bo.controleacesso.PermissaoBO;
...
public class SessaoUsuarioMB extends AbstractUserSession implements Serializable {
    ...
    private List<MarcaModeloBlitz> marcaModeloBlitzs;
    ...
    public void carregarModelos(){
        ...
        marcaModeloBlitzs = marcaModeloBlitzBO.getDAO().listAll();
    }
    ...
    public void criarMenu() {
        ...
        item.setUrl("/admin/view/home.jsf");
    ...
    public List<MarcaModeloBlitz> getMarcaModeloBlitzs() {
        return marcaModeloBlitzs;
    }

    public void setMarcaModeloBlitzs(List<MarcaModeloBlitz> marcaModeloBlitzs) {
        this.marcaModeloBlitzs = marcaModeloBlitzs;
    }
